...
- [Shortcuts](#shortcuts)
- [Scripting](#scripting)
- [BitOS Package Manager](#BitOS-package-manager)
- [Official Apps](#official-apps)
- [Three (OS Assistant)](#three-os-assistant)
- [Kernel Interface](#kernel-interface)
- [App Structure](#app-structure)
- [Metal (@BitOS-core/metal)](#metal-BitOS-coremetal)
- [WebUSB](#webusb)
- [WebHID](#webhid)
...
- [3pm: The BitOS package manager](#BitOS-package-manager)
...
- Optional backend environment / host link with [metal](https://github.com/BitOS-org/metal)
...
- Gamepad support
- It runs Doom (and Wolfenstein 3D! and other DOS stuff!) with [JS-DOS](https://js-dos.com/) (@BitOS-apps/doom, @BitOS-apps/wolfenstein)
- It runs Diablo with [diabloweb](https://d07riv.github.io/diabloweb) (@BitOS-apps/diablo)
- It runs Winamp with [webamp](https://github.com/captbaritone/webamp) (@BitOS-apps/webamp)
...
- Decentralized messaging support with [Mailchain](https://mailchain.xyz) (@BitOS-apps/mailchain)
...
- Decentralized:
  - Open source to customize and host your own copy ([MIT License](https://github.com/BitOS-org/kernel/blob/master/LICENSE))
  - Included [Fleek](https://github.com/BitOS-org/kernel/blob/master/.fleek.json) and [Netlify](https://github.com/BitOS-org/kernel/blob/master/netlify.toml) configs for easy deployment
  - Main site hosted by [Fleek](https://fleek.co) at [https://BitOS.sh](https://BitOS.sh)
  - Backup site hosted on IPFS at [https://BitOS-sh.ipns.dweb.link/](https://BitOS-sh.ipns.dweb.link/)
- Developer-friendly:
  - Easily scriptable and customizable
  - Use an [initfsUrl](https://docs.BitOS.sh/global.html#setupFilesystem) query param to load a ZIP file from a URL to populate your filesystem
  - Use a [mountableFileSystemConfig](https://docs.BitOS.sh/global.html#setupFilesystem) query param to specify how your filesystems should be mounted
...
Not sure where to start? Check out [the issues](https://github.com/BitOS-org/kernel/issues)!

See [CONTRIBUTING.md](https://github.com/BitOS-org/kernel/blob/master/CONTRIBUTING.md)
...
- Visit [https://BitOS.sh](https://BitOS.sh)
...
```sh
git clone git@github.com:BitOS-org/kernel.git
cd kernel
...
Alternatively, install [src/assets/ssl/localhost.crt](https://github.com/BitOS-org/kernel/blob/master/src/assets/ssl/localhost.crt) to your trusted certificate store.
...
BitOS scripts (.sh) are a simple line-by-line execution, while Javascript (.js) offers far more power.

To run a BitOS script: `sh /path/to/script.sh`
...
See some sample scripts at: [https://github.com/BitOS-org/sample-scripts](https://github.com/BitOS-org/sample-scripts)

## BitOS Package Manager

<details>
<summary><strong>Expand BitOS Package Manager</strong></summary>
...
Dependency management is another monster altogether, so that's still a WIP. This means your package should already be bundled when BitOS loads it, or pull in your dependencies some other way.

Here are a few examples of npm libraries that can be successfully loaded in BitOS:
...
- [@BitOS-apps/doom](https://npmjs.org/@BitOS-apps/doom)
- [@BitOS-apps/gun](https://npmjs.org/@BitOS-apps/gun)
- [@BitOS-apps/minipaint](https://npmjs.org/@BitOS-apps/minipaint)
- [@BitOS-apps/moralis](https://npmjs.org/@BitOS-apps/moralis)
- [@BitOS-apps/rubikscube](https://npmjs.org/@BitOS-apps/rubikscube)
- [@BitOS-apps/wolfenstein](https://npmjs.org/@BitOS-apps/wolfenstein)

</details>

See the [full list](https://www.npmjs.com/org/BitOS-apps)
...
This is a brief overview of how to use the kernel, please check [https://docs.BitOS.sh](https://docs.BitOS.sh) for updated documentation.
...
The best way to create applications for BitOS is to create an `npm` package, using any bundler you'd like.
...
// or: export default async function (terminal, context) {
  ...
  // You may also access the BitOS system terminal
...
[@BitOS-apps](https://github.com/BitOS-org/BitOS-apps)

</details>

## Metal (@BitOS-core/metal)
...
Metal is the BitOS hardware link, allowing BitOS access to certain hardware features and other capabilities of the host operating system.
...
The `metal` command is the utility to connect to and interact with BitOS metal servers.

[View the metal repository](https://github.com/BitOS-org/metal)
