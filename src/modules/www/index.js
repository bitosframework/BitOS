...
export const help = `
  ...
  but rather a shell to load url-based apps within BitOS.
...
export async function run (terminal, context = '') {
  ...
  // toolbar.classList.add('BitOS-www-browser-toolbar')
  // addressBar.classList.add('BitOS-www-browser-toolbar-addressbar-input')
  // buttonWrapper.classList.add('BitOS-www-browser-toolbar-button-wrapper')

  toolbar.classList.add(classes['BitOS-www-browser-toolbar'])
  addressBar.classList.add(classes['BitOS-www-browser-toolbar-addressbar-input'])
  buttonWrapper.classList.add(classes['BitOS-www-browser-toolbar-button-wrapper'])
  ...
  const appWindow = kernel.windows.create({
    ...
    class: ['BitOS-window', 'BitOS-www-browser'],
    x: 'center',
    y: 'center',
    width: '75%',
    height: '75%'
