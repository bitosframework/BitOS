...
export const description = 'Three: The open source assistant for BitOS'
export const help = `
  Usage:
    three                             Start Three
...
export function getInstance () {
  return document.querySelector('#BitOS-three-orb')
}
...
export function exit () {
  ...
  say('Goodbye!')
  document.querySelector('#BitOS-three-orb').remove()
}
