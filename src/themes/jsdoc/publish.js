...
function buildNav(members) {
    ...
    if (!isHTML(title)) {
        nav = `
          <a href="index.html"><img class="navbar-logo" src="http://github.com/BitOS-org/kernel/raw/master/.github/iconlogo.png" /></a>
          ...
          <div class="navbar-badges">
            <a class="navbar-badge" href="https://BitOS.sh" target="_blank">
              <img alt="Launch BitOS.sh" src="https://img.shields.io/badge/launch-BitOS.sh-blue?style=for-the-badge" style="max-width: 100%;"></a>
            <a class="navbar-badge" href="https://github.com/BitOS-org/kernel">
              <img alt="View Source" src="https://img.shields.io/badge/repo-BitOS%E2%80%94org%2Fkernel-silver?style=for-the-badge&logo=github" />
            </a>
          </div>
        `
    } else {
...
exports.publish = function(taffyData, opts, tutorials) {
    ...
    if (members.globals.length) {
        generate('', '@BitOS-core/kernel', [{ kind: 'globalobj' }], globalUrl);
    }
